-- Pokemon Catalog Database Schema
...
CREATE UNIQUE INDEX "Card_tcgId_key" ON "Card"("tcgId");
...
CREATE UNIQUE INDEX "CollectionCard_unique" ON "CollectionCard"("collectionId", "cardId", "condition", "language", "isFirstEdition", "isFoil");
...
CREATE INDEX "PriceHistory_cardId_source_recordedAt_idx" ON "PriceHistory"("cardId", "source", "recordedAt");
...
CREATE UNIQUE INDEX "_WantCards_AB_unique" ON "_WantCards"("A", "B");
CREATE INDEX "_WantCards_B_index" ON "_WantCards"("B");

CREATE UNIQUE INDEX "_HaveCards_AB_unique" ON "_HaveCards"("A", "B");
CREATE INDEX "_HaveCards_B_index" ON "_HaveCards"("B");
